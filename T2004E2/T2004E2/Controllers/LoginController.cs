...
namespace T2004E2.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        private readonly T2004E_PContext _context;
        public LoginController(IConfiguration confix, T2004E_PContext context)
        {
            _configuration = confix;
            _context = context;
        }
        [HttpPost]
